    ...
    <div class="container">
      ...
      <div class="row">
       ...
       <div class="col-lg-4 mb-4">
        <div class="entry2">
          <a href="{{ route('website.post',['slug' => $rp->slug]) }}"><img src="{{ $rp->image }}" alt="Image" class="img-fluid rounded"></a>
          <div class="excerpt">
          <span class="post-category text-white bg-secondary mb-3">{{ $rp->category->name }}</span>

          <h2><a href="{{ route('website.post',['slug' => $rp->slug]) }}">{{ $rp->title }}</a></h2>
          <div class="post-meta align-items-center text-left clearfix">
            <figure class="author-figure mb-0 mr-3 float-left"><img src="{{ $rp->user->image }}" alt="Image" class="img-fluid"></figure>
            <span class="d-inline-block mt-1">By <a href="{{ route('website.post',['slug' => $rp->slug]) }}">{{ $rp->user->name }}</a></span>
            <span>{{ $rp->created_at->format('M d,Y') }}</span>
          </div>
          
            <p>{{ Str::limit($rp->description,100) }}</p>
